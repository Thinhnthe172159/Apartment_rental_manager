...
public class RequestContract extends HttpServlet {
    ...
    private String generateMessage(Apartment apartment, String postId, User user,int newNoti_id) {
        return "<table border=\"1\">"
                ...
                + "<input hidden name=\"apartment\"  type=\"text\" value=\"" + apartment.getId() + "\">"
                + "  <textarea id=\"editor\" required=\"\" name=\"description\" class=\"\" placeholder=\"Nhập phản hồi của bạn   \" cols=\"300\" rows=\"10\">\n"
                + "                              \n"
                + "                    </textarea>\n"
                + "\n"           
