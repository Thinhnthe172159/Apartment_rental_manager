...
public class DeleteComment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cpd.deleteComment(comment_id);
        CommunityPost communityPost = commentPost.getPost_id();
        communityPost.setNum_of_comment(cpd.countCommentEachPost(communityPost.getId()));
        cpd.updatePost2(communityPost);
        response.sendRedirect("DetailCommnityPost?post_id=" + communityPost.getId() + "&addCommment=1");
    }
