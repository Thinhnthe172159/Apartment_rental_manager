...
public class ApartmentDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Apartment_Post> apartment_Posts_popular = apartmentPostDao.getApartment_Post_List(null, null, null, null, 0, 0, 0, 0, 0, 0, 0, 0, 1, 10, 4,null);
        ...
        try {
            ...
            List<Apartment_Post> apartment_Post_nearby_list = apartmentPostDao.getApartment_Post_List(null, a.getCity(), null, null, 0, 0, 0, 0, 0, 0, 0, 1, 1, 10, 0,null);
            int page = 2;
