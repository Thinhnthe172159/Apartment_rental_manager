 ...
 * @author vumin
 */
public class AddIncidentReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        IncidentReport report = new IncidentReport(tenant_id, tenant_id, landlord_id, context, image, Status);
