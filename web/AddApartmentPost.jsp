...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .right-align-option select {
                text-align: right;
                direction: rtl;
            }
            .right-align-option option {
                text-align: left;
                direction: ltr;
            }
        </style>
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <select required name="apartment" class="form-select" aria-label="Default select example">
                            ...
                            <c:forEach items="${requestScope.apartmentList}" var="ap">
                                ...
                                <option value="${ap.id}"  <c:if test="${ap.status_apartment == 2}">disabled="" style="color: red"</c:if>>${index}.${ap.name} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <c:if test="${ap.status_apartment == 1}"> <p class="text-end">Chưa có người thuê</p></c:if><c:if test="${ap.status_apartment == 2}"><p>Đã có người thuê</p></c:if></option>
                            </c:forEach>
                        </select>
                    </div>
                    <br>
