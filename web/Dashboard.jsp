    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="Dashboard.jsp"><img src="dashboard/assets/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="Dashboard.jsp"><img src="dashboard/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="dashboard/pages/charts/chartjs.html">
              <i class="mdi mdi-chart-bar menu-icon"></i>
              <span class="menu-title">Charts</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="dashboard/pages/tables/basic-table.html">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="dashboard/assets/images/faces/face22.jpg" alt="" />
                          </div>
                      ...
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboard/assets/images/faces/face25.jpg" alt="" />
                          </div>
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboard/assets/images/faces/face15.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboard/assets/images/faces/face5.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboard/assets/images/faces/face2.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="dashboard/assets/images/dashboard/img_4.jpg" alt="" />
                          <div class="pl-2">
                    ...
                    <div class="row py-3 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="dashboard/assets/images/dashboard/img_5.jpg" alt="" />
                          <div class="pl-2">
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="dashboard/assets/images/faces/face1.jpg" alt="" />
                              <img class="ml-1" src="dashboard/assets/images/faces/face10.jpg" alt="" />
                              <img class="ml-1" src="dashboard/assets/images/faces/face14.jpg" alt="" />
                            </span>
                          </span>
                        </p>
                      </li>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboard/assets/images/faces/face2.jpg" alt="" />
                            </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboard/assets/images/faces/face3.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboard/assets/images/faces/face11.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboard/assets/images/browser-logo/opera-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboard/assets/images/browser-logo/safari-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboard/assets/images/browser-logo/chrome-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboard/assets/images/browser-logo/firefox-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="mr-2" src="dashboard/assets/images/browser-logo/explorer-logo.png" alt="" />
