        ...
        <div class="container-scroller">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                    <a class="sidebar-brand brand-logo" href="Dashboard"><img src="img/Logo.png" alt="logo" /></a>
                    <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="Dashboard"><img src="dashboard/assets/images/logo-mini.svg" alt="logo" /></a>
                </div>
                <ul class="nav">
