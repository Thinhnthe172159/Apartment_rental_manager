...
<body>
    <div class="container">
        ...
        <div class="incident-info">
            <p><strong>Tenant:</strong> ${incident.tenant_id.first_name} ${incident.tenant_id.last_name}</p>
            <p><strong>Landlord:</strong> ${incident.landlord_id.first_name} ${incident.landlord_id.last_name}</p>
