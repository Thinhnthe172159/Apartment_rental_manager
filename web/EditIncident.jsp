    ...
    <div class="container">
        ...
        <form action="EditIncident" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="tenantEmail" name="tenantEmail" class="form-control" value="${incident.tenant.email}" readonly>
            </div>

            <div class="form-group">
                <label for="landlordEmail">Landlord Email:</label>
                <input type="text" id="landlordEmail" name="landlordEmail" class="form-control" value="${incident.landlord.email}" readonly>
            </div>

            <div class="form-group">
                <label for="context">Context:</label>
                <textarea id="context" name="context" class="form-control" rows="5">${incident.context}</textarea>
            </div>
