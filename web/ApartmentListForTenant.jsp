    ...
    <body>
        ...
        <div class="row">
            ...
            <c:if test="${messagedanger != null}">
                <div style="width: 100%; text-align: center" class="alert alert-danger" role="alert">
                    ${messagedanger}
                </div>
            </c:if>
            <div class="col-lg-10 mx-auto">
                <div class="career-search mb-60">
                    ...
                    <form action="AparmentListForTenant" method="get" class="career-form mb-60">
                        <div class="row">
                    ...
                    <div class="card">
                                                                    ...
                                                                    <td>
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                ...
                                                                                <li><button class="dropdown-item" type="button"><a href="SendMaintenanceReport?apartment_id=${ap.id}">Send Maintenance Report</a></button></li>
                                                                            </ul>
                                                                        </div>
                                                                    </td>
                                                                    <!--<td>.</td>-->
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-reset justify-content-center">
                                <c:if test="${pageIndex > 1}">
                                    <li class="page-item">
                                        <a class="page-link" tabindex="-1" aria-disabled="true" href="AparmentListForTenant?page_index=${pageIndex-1}&name=${name}&Apartment_type=${Apartment_type}&status=${status}&tinh=${tinh}&quan=${quan}&phuong=${phuong}">
                                            <i class="">previous</i>
                                        </a>
                                    </li>
                                </c:if>
                                <c:forEach items="${requestScope.pagelist}" var="i">
                                    <li class="page-item ${i == pageIndex ? 'active' : ''}"><a class="page-link" href="AparmentListForTenant?page_index=${i}&name=${name}&Apartment_type=${Apartment_type}&status=${status}&tinh=${tinh}&quan=${quan}&phuong=${phuong}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item">
