            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
                    <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
                        <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="Dashboard"><img src="dashboard/assets/images/logo-mini.svg" alt="logo" /></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="py-1">
                                                            <img src="dashboard/assets/images/faces-clipart/pic-1.png" alt="image" />
                                                        </td>
                                                        <td>Herman Beck</td>
                                                        <td>
                                                            <div class="progress">
                                                    ...
                                                    <tr>
                                                        <td class="py-1">
                                                            <img src="dashboard/assets/images/faces-clipart/pic-2.png" alt="image" />
                                                        </td>
                                                        <td>Messsy Adam</td>
                                                        <td>
                                                            <div class="progress">
                                                    ...
                                                    <tr>
                                                        <td class="py-1">
                                                            <img src="dashboard/assets/images/faces-clipart/pic-3.png" alt="image" />
                                                        </td>
                                                        <td>John Richards</td>
                                                        <td>
                                                            <div class="progress">
                                                    ...
                                                    <tr>
                                                        <td class="py-1">
                                                            <img src="dashboard/assets/images/faces-clipart/pic-4.png" alt="image" />
                                                        </td>
                                                        <td>Peter Meggik</td>
                                                        <td>
                                                            <div class="progress">
