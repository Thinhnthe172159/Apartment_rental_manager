                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="DashboardAddUser" method="post" class="forms-sample">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first-name" class="form-control-lg" id="first_name" placeholder="First Name" value="${param['first-name']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last-name" class="form-control-lg" id="last_name" placeholder="Last Name" value="${param['last-name']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" class="form-control-lg" id="email" placeholder="Email" value="${param['email']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password" class="form-control-lg" id="password" placeholder="Password" value="${param['password']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="re-password" class="form-control-lg" id="repeat password" placeholder="Repeat Password"value="${param['re-password']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control-lg" id="role" name="role" required="">
                                                    <c:forEach items="${role_List}" var="r">
                                                        <option value="${r.getId()}" ${r.getId() == param.role ? 'selected' : ''}>${r.getRole_name()}</option>
                                                    </c:forEach>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="dob" class="form-control-lg" id="dob" value="${param['dob']}" required=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" name="money" class="form-control-lg" id="amount" value="${param['money']}" required=""/>
