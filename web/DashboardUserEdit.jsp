                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="EditUser" method="post" class="forms-sample">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="${specific_user_data.first_name}" name="first-name" class="form-control-lg" id="first_name" placeholder="First Name" />
                                            </div>
                                            <div class="form-group">
                                                <label for="last_name">Last Name</label><br>
                                                <input type="text" value="${specific_user_data.last_name}" name="last-name" class="form-control-lg" id="last_name" placeholder="Last Name" />
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email address</label><br>
                                                <input type="email" value="${specific_user_data.email}"name="email" class="form-control-lg" id="email" placeholder="Email" />
                                            </div>
                                            <div class="form-group">
                                                <label for="password">Password</label><br>
                                                <input type="password" value="${specific_user_data.password}" name="password" class="form-control-lg" id="password" placeholder="Password" />
                                            </div>
                                            <div class="form-group">
                                                <label for="role">Role</label><br>
                                                <select class="form-control-lg" id="role" name="role">
...
<!--                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="${specific_user_data.dob}" name="dob" class="form-control-lg" id="dob"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="amount">Amount</label><br>
                                                <input type="number" step="any" value="${specific_user_data.money}" name="money" class="form-control-lg" id="amount"/>
                                            </div>
<!--                                            <div class="form-group">
