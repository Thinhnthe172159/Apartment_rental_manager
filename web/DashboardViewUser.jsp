...
<!--                                        <form action="ViewUser" method="post" class="forms-sample">-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="${specific_user_data.first_name}" name="first-name" class="form-control-lg" id="first_name" placeholder="First Name" readonly=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="${specific_user_data.last_name}" name="last-name" class="form-control-lg" id="last_name" placeholder="Last Name" readonly=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="${specific_user_data.email}"name="email" class="form-control-lg" id="email" placeholder="Email" readonly=""/>
...
<!--                                            <div class="form-group">
                                                ...
                                                <input type="password" value="${specific_user_data.password}" name="password" class="form-control-lg" id="password" placeholder="Password" readonly=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" value="${specific_user_data.password}" name="re-password" class="form-control-lg" id="password" placeholder="Password" readonly=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control-lg" id="role" name="role" readonly="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="${specific_user_data.dob}" name="dob" class="form-control-lg" id="dob" readonly=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" value="${specific_user_data.money}" name="money" class="form-control-lg" id="amount" readonly=""/>
                                            ...
                                            <a href="DashboardUser" class="btn btn-light">Back</a>
                                        <!--</form>-->
                                    </div>
                                </div>
                            </div>
